            ...
            <div class="flex justify-center pb-10">
                    ...
                    <div class="ml-10">
                        <div class="flex items-center">
                            ...
                            <inertia-link v-if="userProfile.id === $page.props.user.id" href="/user/profile" class="cursor-pointer h-7 px-3 ml-3 focus:outline-none hover:border-transparent text-center rounded border border-gray-400 hover:bg-blue-500 hover:text-white bg-transparent text-gray-500 font-semibold">Editar perfil</inertia-link>
